...
<div class="w-full h-screen flex flex-col items-center px-5 overflow-x-scroll">
    <div class="w-full h-max border border-zinc-700 rounded-md flex flex-row justify-between items-center gap-2 px-5 py-2 my-5">
    ...
    <?php require_once("../components/tukarVoucher.php") ?>
...
<div class="fixed bottom-5 left-4 rounded-lg w-11/12 bg-zinc-700 text-white shadow-lg">
    <div class="flex items-center justify-around p-4">
        <div onclick="document.location.href='<?= $url ?>/App/pages/home.php'" class=" p-2 bg-zinc-700 rounded-md flex flex-row items-center gap-3">
            ...
            <!-- <h1 class="font-bold mr-3">Home</h1> -->
        </div>
        <div onclick="document.location.href='<?= $url ?>/App/pages/voucherMasyarakat.php'" class=" p-2 bg-white rounded-md flex flex-row items-center gap-3">
            <svg fill="#3f3f46" fill-rule="evenodd" id="fi_9573491" height="30" viewBox="0 0 32 32" width="30" xmlns="http://www.w3.org/2000/svg">
