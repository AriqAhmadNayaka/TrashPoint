...
<div class="w-full h-screen flex flex-col items-center px-5 overflow-x-scroll">
    <!-- <div class="w-full h-max border border-zinc-700 rounded-md flex flex-row justify-between items-center gap-2 px-5 py-2 mt-5">
        <div class="flex flex-col">
            <h1 class="text-sm">Your point : <span class="text-2xl font-semibold"><?= $_SESSION["userData"]["point"] ?></span></h1>
            <h1 class="text-sm">Tukar point anda dengan voucher!</h1>
        </div>
        <div class="">
            <img src="../../assets/images/coins.jpg" style="height: 100px; width: 100px;" alt="">
        </div>
    </div> -->
    <?php require_once("../components/historyBuangsampah.php") ?>
    <?php require_once("../components/historyPenukaran.php") ?>

    <div class="w-full h-1 mt-28"></div>
</div>
...
<div class="fixed bottom-5 left-4 rounded-lg w-11/12 bg-zinc-700 text-white shadow-lg">
    <div class="flex items-center justify-around p-4">
        <div onclick="document.location.href='<?= $url ?>/App/pages/home.php'" class=" p-2 bg-zinc-700 rounded-md flex flex-row items-center gap-3">
        ...
        <div onclick="document.location.href='<?= $url ?>/App/pages/historyMasyarakat.php'" class=" p-2 bg-white rounded-md flex flex-row items-center gap-3">
            <svg fill="#3f3f46" fill-rule="evenodd" width="30" height="30" version="1.1" id="fi_754201" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 409.6 409.6" style="enable-background:new 0 0 409.6 409.6;" xml:space="preserve">
                <g>
                    <g>
