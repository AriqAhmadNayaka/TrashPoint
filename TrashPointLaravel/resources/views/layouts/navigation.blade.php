<nav x-data="{ open: false }" class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    {{-- TAMBAHAN MENU KHUSUS ADMIN (DENGAN PENGECEKAN DATABASE ATAU KEYWORD EMAIL) --}}
                    @if(str_contains(Auth::user()->email, 'admin') || \App\Models\Admin::where('user_id', Auth::id())->exists())
                        <x-nav-link :href="route('admin.monitoring')" :active="request()->routeIs('admin.monitoring')">
                            {{ __('Monitoring Sampah') }}
                        </x-nav-link>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            {{-- MENU RESPONSIVE KHUSUS ADMIN (DENGAN PENGECEKAN DATABASE ATAU KEYWORD EMAIL) --}}
            @if(str_contains(Auth::user()->email, 'admin') || \App\Models\Admin::where('user_id', Auth::id())->exists())
        ...
        <div class="pt-4 pb-1 border-t border-gray-200 dark:border-gray-600">
            <div class="px-4">
                ...
                <div class="font-medium text-sm text-gray-500">{{ Auth::user()->email ?? 'guest@trashpoint.com' }}</div>
            </div>
